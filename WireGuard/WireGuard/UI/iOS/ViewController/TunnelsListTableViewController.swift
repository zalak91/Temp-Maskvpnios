...
var mainVC: MainViewController?
    ...
    @objc func settingsButtonTapped(sender: UIBarButtonItem) {
        ...
        let urlPath = Bundle.main.url(forResource: "user9", withExtension: "conf")
     //   guard let tunnelsManager = mainVC?.tunnelsManager else { return true }
        TunnelImporter.importFromFile(urls: [urlPath!], into: tunnelsManager!, sourceVC: mainVC, errorPresenterType: ErrorPresenter.self) {
            _ = FileManager.deleteFile(at: urlPath!)
        }
     //   return true
