...
extension UIViewController {
    ...
    fileprivate func showAppUpdateAlert( version: String, force: Bool, appURL: String) {
        ...
        if !force {
            let notNowButton = UIAlertAction(title: "Not Now", style: .default) { (_: UIAlertAction) in
        ...
        let updateButton = UIAlertAction(title: "Update", style: .default) { (_: UIAlertAction) in
            print("Call API")
            print("No update")
